...
namespace dukat
{
	struct Events
	{
		...
		static constexpr Event Created = 1;
		static constexpr Event Destroyed = 2;
		static constexpr Event Selected = 3;
		static constexpr Event Deselected = 4;
		static constexpr Event ParentChanged = 5;
		static constexpr Event TransformChanged = 6;
		static constexpr Event VisibilityChanged = 7;
		static constexpr Event Any = 8; // catch-all to allow subscription to all supported events
	};
